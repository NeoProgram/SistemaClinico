  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">( Nombre Completo )</li>
      </ol>
    </section>
	 ...
	 <!-- Formulario de Registro de Medico -->
	  ...
	  <div class="box"><!-- put it back (collapsed-box) -->
            <div class="box-header with-border">
			  ...
			  <h1 class="box-title"><b>Perfil del Usuario ( Nombre Completo )</b></h1>
...
<div class="register-box perfilMedico">
  <div class="register-logo">
    <a href="../index.html"><b>Perfil del Usuario</b></a>
  </div>
			...
			<div class="box-footer no-padding">
			  ...
			  <li>
                  ...
                  <select onchange="this.className=this.options[this.selectedIndex].className" class="greenText form-control medicoEstatus">
                       <option class="greenText form-control activoGreen1" value="activo">Activo</option>
                       <option class="redText form-control inactivoRed1" value="inactivo">Inactivo</option>
                  </select>
                </div>
			  </li>
				<li>
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Perfil del Usuario</p>
    ...
    <form action="../index.html" method="post">
	  ...
	  <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Vinculo con el Usuario">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
