...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="active">
          <a href="citasPaciente.html">
            <i class="fa fa-address-card-o"></i> <span>Citas del Paciente</span>
			<span class="pull-right-container">
            <small class="label pull-right bg-blue">28</small>
			</span>
          </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Listado de Citas del Paciente (Nombre Completo)
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body" style="overflow-x:scroll;">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>4</td>
                  <td>X</td>
				  <td><button type="button" class="btn btn-block btn-info citasPaciente"><a href="expediente.php">Expediente</a></button></td>
                </tr>
                <tr>
                  <td>Trident</td>
