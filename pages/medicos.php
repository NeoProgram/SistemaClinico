  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	 ...
	 <div class="box">
			...
			<i class="fa fa-user-plus"></i>
              <h3 class="box-title"><b>Listado de Medicos Racderma Satelite</b></h3>
            </div>
            <!-- /.box-header -->
...
if($result = mysqli_query($db, $sql)){
	...
	echo "<div class='box-body' style='overflow-x:scroll;'>";
        echo "<table id='example1' class='table table-bordered table-striped'>";
		  echo "<thead>";
            echo "<tr>";
			    echo "<th>estatus_medico</th>";
				echo "<th>View Profile</th>";
				
			    echo "<th>medico_id</th>";
				...
				echo "<th>cedula_pro</th>";
				echo "<th>whatsapp</th>";
				echo "<th>email</th>";
                echo "<th>username</th>";
				echo "<th>usuario_registra</th>";
				echo "<th>notas</th>";
				echo "<th>choose_radio_days</th>";
				echo "<th>numero_dias</th>";
				echo "<th>my_checkbox</th>";
				echo "<th>start_date</th>";
				echo "<th>end_date</th>";
				echo "<th>total_days</th>";
				echo "<th>fecha_reg_medico</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			    ...
			    echo "<tr>";
				    echo "<td>
					<select onchange='this.className=this.options[this.selectedIndex].className' class='greenText form-control medicoEstatus' id='estatus_medico'>
					
                       <option class='greenText form-control activoGreen1'>Activo</option>
                       <option class='redText form-control inactivoRed1'>Inactivo</option>
                  </select>
				  </td>";
					echo "<td><button type='button' class='btn btn-block btn-info citasPaciente'><a href='medicosProfile.php'>View Profile</a></button></td>";
					
					echo "<td>" . $row['medico_id'] . "</td>";
					echo "<td>" . $row['clinica_id'] . "</td>";
                    echo "<td>" . $row['estatus_medico'] . "</td>";
                    echo "<td>" . $row['apellido_paterno'] . "</td>";
                    echo "<td>" . $row['apellido_materno'] . "</td>";
					echo "<td>" . $row['primer_nombre'] . "</td>";
					echo "<td>" . $row['segundo_nombre'] . "</td>";
                    echo "<td>" . $row['cedula_pro'] . "</td>";
					echo "<td>" . $row['whatsapp'] . "</td>";
                    echo "<td>" . $row['email'] . "</td>";
                    echo "<td>" . $row['username'] . "</td>";
                    echo "<td>" . $row['usuario_registra'] . "</td>";
                    echo "<td>" . $row['notas'] . "</td>";
					echo "<td>" . $row['choose_radio_days'] . "</td>";
					echo "<td>" . $row['numero_dias'] . "</td>";
					echo "<td>" . $row['my_checkbox'] . "</td>";
					echo "<td>" . $row['start_date'] . "</td>";
					echo "<td>" . $row['end_date'] . "</td>";
					echo "<td>" . $row['total_days'] . "</td>";
					echo "<td>" . $row['fecha_reg_medico'] . "</td>";
