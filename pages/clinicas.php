    ...
    <section class="content">
	  ...
	  <div class="box">
            <div class="box-header with-border">
			  ...
			  <h1 class="box-title"><b>Citas en Racderma Satelite</b></h1>
        ...
        <div class="col-md-3">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">Medicos en Racderma Satelite</h4>
            </div>
            <div class="box-body">
              <!-- the events -->
              <div id="external-events">
                <div class="external-event bg-green">Rafael Martin</div>
                <div class="external-event bg-yellow">Katerina Ana</div>
                <div class="external-event bg-aqua">Ester Catalina</div>
                <div class="external-event bg-light-blue">Alena Belen</div>
                <div class="external-event bg-red">Rafael Leonardo</div>
				<div class="external-event bg-black">Helena Teresa</div>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
	 ...
	 <div class="box">
            <div class="box-header">
              <h3 class="box-title"><b>Listado de Citas para el dia de Hoy</b></h3>
            </div>
            <!-- /.box-header -->
			<div class="box-body" style="overflow-x:scroll;">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>Trident1</td>
				  <td>16/11/2019 de 13:00 - 14:00</td>
				  <th>Realizada</th>
                  ...
                  <td>4</td>
                  <td>X</td>
				  <td><button type="button" class="btn btn-block btn-info citasPaciente"><a href="expediente.html">Expediente</a></button></td>
				  <td><button type="button" class="btn btn-block btn-success citasPaciente"><a href="verCita.html">Ver Cita</a></button></td>
                </tr>
                <tr>
                  <td>Trident</td>
				  <td>28/11/2019 de 13:00 - 14:00</td>
				  <th>Realizada</th>
                  <td>Internet Explorer 4.0</td>
                  <td>Win 95+</td>
                  <td>4</td>
