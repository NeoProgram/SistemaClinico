  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <label>Usuario ID:</label>
        <input type="text" class="form-control" placeholder="Usuario ID">
	 ...
	 <div class="box">
			...
			<i class="fa fa-user-plus"></i>
              <h3 class="box-title"><b>Usuarios en Sistema Clinico</b></h3>
            </div>
            <!-- /.box-header -->
...
if($result = mysqli_query($db, $sql)){
	...
	echo "<div class='box-body' style='overflow-x:scroll;'>";
        echo "<table id='example1' class='table table-bordered table-striped'>";
		  echo "<thead>";
            echo "<tr>";
			    echo "<th>estatus_usuario</th>";
				echo "<th>View Profile</th>";
				
			    echo "<th>usuario_id</th>";
				echo "<th>estatus_usuario</th>";
				echo "<th>rol_usuario</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			    ...
			    echo "<tr>";
					...
					echo "<td><button type='button' class='btn btn-block btn-info citasPaciente'><a href='usuariosProfile.php'>View Profile</a></button></td>";
					...
					echo "<td>" . $row['fecha_reg_usuario'] . "</td>";
