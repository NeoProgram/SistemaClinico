  ...
  <aside class="main-sidebar" style="position:fixed;">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="active">
          <a href="medicosProfile.php">
            <i class="fa fa-user-md"></i>
            <span>Perfil del Medico</span>
            <!-- <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span> -->
          </a>
	 ...
	 <!-- Formulario de Registro de Medico -->
	  ...
	  <div class="box"><!-- put it back (collapsed-box) -->
            <div class="box-header with-border">
			  ...
			  <h1 class="box-title"><b>Perfil del Medico ( Nombre Completo )</b></h1>
...
<div class="register-box perfilMedico">
  <div class="register-logo">
    <a href="../index.html"><b>Perfil del Medico</b></a>
  </div>
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Perfil del Medico</p>
