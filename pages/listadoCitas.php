...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Listado de Citas Racderma Satelite
      </h1>
      <ol class="breadcrumb">
...
<div class="box">
			...
			<!-- Date and time range -->
              <div class="form-group" align="center">
                <label>Listado de Citas por Fecha:</label>
				...
				<!-- No total de Citas -->
			 <div class="totalCitasBox">
	            <div class="form-group has-feedback">
	              <label>No total de Citas:</label>
                  <input type="text" class="form-control" placeholder="No total de Citas">
                  <span class="form-control-feedback"><i class="fa fa-sort-numeric-asc"></i></span>
                </div>
				</div>
              </div>
              <!-- /.form group -->
...
if($result = mysqli_query($db, $sql)){
	...
	echo "<div class='box-body' style='overflow-x:scroll;'>";
        echo "<table id='example1' class='table table-bordered table-striped'>";
		  echo "<thead>";
            echo "<tr>";
				...
				echo "<th>procedimiento_id</th>";
				echo "<th>consulta_id</th>";
				...
				echo "<th>fecha_reg_cita</th>";
				echo "<th>fecha_hora_cita</th>";
				echo "<th>cita_comienza</th>";
				echo "<th>cita_termina</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			    ...
			    echo "<tr>";
				    echo "<td><button type='button' class='btn btn-block btn-info citasPaciente'><a href='expediente.php'>Expediente</a></button></td>";
					echo "<td><button type='button' class='btn btn-block btn-success citasPaciente'><a href='verCita.php'>Ver Cita</a></button></td>";
                    echo "<td>" . $row['cita_id'] . "</td>";
                    echo "<td>" . $row['paciente_id'] . "</td>";
                    echo "<td>" . $row['clinica_id'] . "</td>";
					echo "<td>" . $row['medico_id'] . "</td>";
					echo "<td>" . $row['procedimiento_id'] . "</td>";
					...
					echo "<td>" . $row['fecha_reg_cita'] . "</td>";
					echo "<td>" . $row['fecha_hora_cita'] . "</td>";
					echo "<td>" . $row['cita_comienza'] . "</td>";
					echo "<td>" . $row['cita_termina'] . "</td>";
