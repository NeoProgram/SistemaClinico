    ...
    <section class="content">
	 ...
	 <div class="box"><!-- put it back (collapsed-box) -->
            <div class="box-header with-border">
			  ...
			  <h1 class="box-title"><b>Formulario para Crear una Cita</b></h1>
...
<div class="register-box perfilMedico">
  <div class="register-logo">
    <b>Formulario para Crear una Cita</b>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Formulario para Crear una Cita</p>

<!-- form -->
    <form method="post">
	  <div class="form-group has-feedback" style="display: none;">
	  <label>Usuario que Crea la Cita:</label>
        <input type="text" readonly="readonly" class="form-control" placeholder="Usuario que Crea la Cita" value="<?php echo $_SESSION['sc_usuarios']['username'];?>" name="usuario_registra">
	...
	<!-- Estatus Cita -->
	  <div class="form-group">
                  ...
                  <select onchange="this.className=this.options[this.selectedIndex].className" class="greenText form-control medicoEstatus" name="estatus_cita">
                       <option class="greenText form-control activoGreen1" value="1" ><h1>Confirmada</h1></option>
                       <option class="redText form-control inactivoRed1"   value="0" >Cancelada</option>
                  </select>
                </div>
	  
	  <!-- Numero de Paciente ( Implementar con autocomplete ) --> 
	   <div class="form-group has-feedback">
	    <label>Paciente No:</label>
        <input type="text" class="form-control" placeholder="Numero de Paciente" value="" name="paciente_id">
	  ...
	  <!-- Procedimiento -->
	  <div class="form-group">
                  <label>Procedimiento: Elija la Procedimiento correspondiente</label>
                  <select class="form-control" name="procedimiento_id">
                    <option value="1">Depilacion p</option>
                    <option value="2">Radio Frecuencia</option>
                    <option value="3">Retiro de Tatuaje</option>
                    <option value="4">Laser CO2</option>
                    <option value="5">Botox</option>
					<option value="6">Relleno</option>
					<option value="7">Peeling</option>
					<option value="8">Ninguno</option>
                  </select>
       </div>
	  <!-- Consulta -->
	  <div class="form-group">
                  <label>Consulta: Elija la Consulta correspondiente</label>
                  <select class="form-control" name="consulta_id">
                    <option value="1">Consulta de 1ra Vez</option>
                    <option value="2">Consulta Subsecuente</option>
                    <option value="3">Valoracion Cosmetica</option>
	  ...
	  <div class="form-group">
                  <label>Medico que Atiende al Paciente:</label>
                  <select class="form-control" name="medico_id">
                    <option value="1">Rafael Martin</option>
                    <option value="2">Katerina Ana</option>
                    <option value="3">Ester Catalina</option>
					<option value="4">Alena Belen</option>
                    <option value="5">Rafael Leonardo</option>
                    <option value="6">Helena Teresa</option>
                  </select>
       </div>
	  ...
	  <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control pull-right" id="reservationtime" name="fecha_hora_cita">
                </div>
                <!-- /.input group -->
       </div>
	  ...
	  <!-- Apellido Paterno ( Implementar con autocomplete ) --> 
      ...
      <div class="row">
        ...
        <div>
		  ...
		  <button type="submit" class="btn btn-block btn-primary" name="crear_cita">Crear Cita</button>
