...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Expediente del Paciente (Nombre Completo)
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
	 ...
	 <div class="box"><!-- put it back (collapsed-box) -->
            <div class="box-header with-border">
			  ...
			  <h1 class="box-title"><b>Expediente Clinico del Paciente</b></h1>
...
<div class="register-box perfilMedico">
  <div class="register-logo">
    <div><b>Expediente Clinico del Paciente</div>
  </div>
  
  <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Nombre Completo" value="<?php echo $row["apellido_paterno"]; ?><?php echo $row["primer_nombre"]; ?>">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Expediente Clinico</p>

    <form action="../index.html" method="post">
	  <div class="form-group has-feedback" style="display: none;">
	  <label>Usuario que Registra:</label>
        <input type="text" class="form-control" placeholder="Usuario que Registra">
